...
question_list.append(Question('Сколько цилиндров у мотоцикла Урал?', '2', '3', '4 ','1'))
question_list.append(Question('Зачем человеку ноги', 'ходить','прыгать','сидеть','не знаю'))
...
window.score = 0
window.total = 0
# убрали тест, здесь нужна проверка ответа
next_question()
